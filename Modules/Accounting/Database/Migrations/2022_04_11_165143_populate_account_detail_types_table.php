...
'account_subtype_id' => '4', 
                ...
                'active' => '1',
                'description' => 'Accounts receivable (also called A/R, Debtors, or Trade and other receivables) tracks money that customers owe you for products or services, and payments customers make. The accounting module automatically creates one Accounts receivable account for you. Most businesses need only one. Each customer has a register, which functions like an Accounts receivable account for each customer.',
                'created_at' => $timestamp,
                'updated_at' => $timestamp,
            ],
            35 => [
...
'account_subtype_id' => '5', 
                'name' => 'Bank',
                'active' => '1',
                'description' => 'Use Bank accounts to track all your current activity, including debit card transactions. Each current account your company has at a bank or other financial institution should have its own Bank type account.',
                'created_at' => $timestamp,
                'updated_at' => $timestamp,
            ],
            36 => [
...
'account_subtype_id' => '8', 
                ...
                'active' => '1',
                'description' => 'Accounts payable (also called A/P, Trade and other payables, or Creditors) tracks amounts you owe to your suppliers. The application automatically creates one Accounts Payable account for you. Most businesses need only one.',
                'created_at' => $timestamp,
                'updated_at' => $timestamp,
            ],
            65 => [
...
'account_subtype_id' => '10', 
                ...
                'active' => '1',
                'description' => 'The application creates this account the first time you enter an opening balance for a balance sheet account. As you enter opening balances, it records the amounts in Opening balance equity. This ensures that you have a correct balance sheet for your company, even before you\'ve finished entering all your company\'s assets and liabilities.',
                'created_at' => $timestamp,
                'updated_at' => $timestamp,
            ],
            70 => [
...
'account_subtype_id' => '10', 
                ...
                'active' => '1',
                'description' => 'The application adds this account when you create your company. Retained earnings tracks net income from previous financial years. It automatically transfers your profit (or loss) to Retained earnings at the end of each financial year.',
                'created_at' => $timestamp,
                'updated_at' => $timestamp,
            ],
            79 => [
